...
const ProjectsSection = ({ isDesktop }: IDesktop) => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      ...
      <h1 className="section-heading seq mt-2">MY BLOGS</h1>
      <h2 className="text-2xl md:max-w-3xl w-full seq max-w-sm mt-2">
        I have written over 20+ original blogs since 2020,
        contributed in projects ranging from Frontend to Backend development.
      </h2>
    </div>
  );
