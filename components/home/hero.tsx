...
const HERO_STYLES = {
  ...
  CONTENT: "font-medium flex flex-col pt-32 md:pt-0 select-none z-40",
  ...
  const renderHeroContent = (): React.ReactNode => (
    <div className={HERO_STYLES.CONTENT}>
      <div className="md:mb-4 mb-2">
        ...
        <h1 className="text-3xl seq">I am modest SYJun</h1>
      </div>
      <p className="mb-4">
      ...
      <div className="flex seq">
        <nav className={`outer-menu ${aboutVisible ? "menu-visible" : ""}`}>
          <Button
            onClick={setaboutVisible.bind(null, !aboutVisible)}
            classes="mr-3"
